...
public class NewRestfulApiWizard extends Wizard implements INewWizard {
	...
	public boolean performFinish() {
		...
		//获得当前选择的包名
		String packageName = choseOpsInstanceRestfulapiWizard.getIPath().toOSString();
